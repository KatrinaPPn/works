...
<canvas id="bchart" height="400" width="600">您的浏览器不支持HTML5 Canvas</canvas>

<script type="text/javascript">
 
        // 图表数据
        var arrVisitors = new Array();
        arrVisitors[0] = "<?php echo $tu_result[0][0];?>, <?php echo $tu_result[0][1];?>";
        arrVisitors[1] = "<?php echo $tu_result[1][0];?>, <?php echo $tu_result[1][1];?>";
        arrVisitors[2] = "<?php echo $tu_result[2][0];?>, <?php echo $tu_result[2][1];?>";
